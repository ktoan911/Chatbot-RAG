...
class Gemini_LLM:
    def __init__(
        ...
        if instructions is not None:
            self.model = genai.GenerativeModel(model, system_instruction=[
                                               instructions], generation_config={'temperature': temperature})
        else:
            self.model = genai.GenerativeModel(model, generation_config={
